...
The most recent versions of this plugin runs in beets `v2.6` and above (<`v2.7`), though
older versions of the plugin have additional compatibility back to `v1.6`.
